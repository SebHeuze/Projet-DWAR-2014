$(document).ready(function(){
	...
	function getAdresseDepart() {
		...
		).fail(function(xhr, textStatus, errorThrown) { alert("Une erreur est survenue à cause d'un défaut dans les données de la Tan ou l'adresse recherchée n'existe pas"); });
	}
